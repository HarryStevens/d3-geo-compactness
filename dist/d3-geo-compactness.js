// https://github.com/HarryStevens/d3-geo-compactness#readme Version 0.0.3. Copyright 2021 Harry Stevens.
(function (global, factory) {
  ...
  function enclose$1(points) {
    ...
    stereo.rotate(centroid.map(function (d) {
      return -d;
    }));

    var _packEnclose = enclose(stereoCircles(points)),
        x = _packEnclose.x,
        y = _packEnclose.y,
  ...
  function stereoCircles(points) {
    return points.map(function (d) {
      var g = geoCircle().center(d).radius((d[2] || 0) + .2)().coordinates[0],
          f = [g[0], g[20], g[40]].map(stereo),
          // sample 3 of the 60 points given by geoCircle
      c = circumcenter$1(f);
      return {
        x: c[0],
        y: c[1],
